...
class  ZigCCParser : public antlr4::Parser {
public:
  enum {
  ...
  explicit ZigCCParser(antlr4::TokenStream *input);

  ZigCCParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~ZigCCParser() override;
  ...
  public:
    ZigCCParser::DeclarationseqContext *namespaceBody = nullptr;
